...
== Description ==
This plugin lets the user write a separate description for each post, page or custom post type post which is added as a meta description to the html head.
...
To edit a front page description you would go to Dashboard > Settings > Gemeral and edit Tagline.

= Docs & Support =
You will find more and updated information about the plugin at the plugin [website](http://easy-wp-plugin.com/meta-description/)
